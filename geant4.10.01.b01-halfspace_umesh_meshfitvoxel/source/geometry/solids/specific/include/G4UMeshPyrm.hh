...
//
//
// $Id: G4UMeshPyrm.hh 76263 2013-11-08 11:41:52Z gcosmo $
//
//
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
#ifndef G4UMESHPYRM_HH
#define G4UMESHPYRM_HH

#include "G4UMeshElement1st.hh"

using namespace std;

class G4UMeshPyrm : public G4UMeshElement1st
{

  public:  // with description

    G4UMeshPyrm(const G4String& pName,
  ...
  public:   // without description
    ...
    const char* CVSHeaderVers()
      { return "$Id: G4UMeshPyrm.hh 76263 2013-11-08 11:41:52Z gcosmo $"; }
