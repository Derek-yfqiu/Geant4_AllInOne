...
//
//
// $Id: G4VScoringMesh.hh 81087 2014-05-20 15:44:27Z gcosmo $
//
...
enum MeshShape { boxMesh, cylinderMesh, sphereMesh , unstrMesh, undefinedMesh = -1};
...
class G4VScoringMesh
{
  ...
  { return ((sizeIsSet && nMeshIsSet) || IsUMeshRead ); }


  //for unstructured mesh
  void          setUMeshFileName(G4String & aFileName) {fMeshFileName = aFileName;};
  void          setUMeshFormat (G4String & aMeshFileFormat) ;
...
protected:
  ...
  std::vector <G4VPhysicalVolume * > fElementPVList;
  G4bool        IsUMeshRead;
...
public:
  ...
  inline void SetMeshElementPVList(std::vector <G4VPhysicalVolume * > & aElementPVList)
  { fElementPVList = aElementPVList ; }
  inline G4LogicalVolume* GetMeshElementLogical() const
  { return fMeshElementLogical; }
  inline std::vector <G4VPhysicalVolume * > * GetMeshElementPVList()
  { return &fElementPVList; }
};
